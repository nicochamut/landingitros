      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid md:grid-cols-4 gap-10 md:gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="mailto:nicolas@itros.ar" className="text-white/72 hover:text-[#2794F6] transition-colors">nicolas@itros.ar</a></li>
              <li><a href="mailto:maxi@itros.ar" className="text-white/72 hover:text-[#2794F6] transition-colors">maxi@itros.ar</a></li>
              <li><a href="tel:+5493417415834" className="text-white/72 hover:text-[#2794F6] transition-colors">+54 9 3417 41-5834</a></li>
              <li><a href="#contacto" className="text-white/72 hover:text-[#2794F6] transition-colors">Agendar reuni&oacute;n</a></li>
            </ul>
          </div>
        </div>
